      ...
      {activeTab === "details" && (
        <div className="bg-white shadow-md p-6 rounded-xl space-y-3 max-w-xl">
          ...
          <input
            ...
            onChange={(e) => setDetailsData({ ...detailsData, color: e.target.value })}
          />
          <input
            type="text"
            placeholder="Size"
            ...
            onChange={(e) => setDetailsData({ ...detailsData, size: e.target.value })}
          />
          <input
            type="text"
            placeholder="Weight"
            ...
            onChange={(e) => setDetailsData({ ...detailsData, weight: e.target.value })}
          />
          <button
